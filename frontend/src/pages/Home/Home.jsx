        ...
        <div className="container">
          <div className="row text-center pb-5">
            <div className="col-md-3 col-sm-6 p-4">
              <FiHeadphones className="mb-4" size={35} color="tomato" />
            ...
            <div className="col-md-3 col-sm-6 p-4">
              <FiCreditCard className="mb-4" size={35} color="tomato" />
            ...
            <div className="col-md-3 col-sm-6 p-4">
              <FiCornerUpLeft className="mb-4" size={35} color="tomato" />
              <h3>FREE RETURNS</h3>
              <p>Easy & Free</p>
              <div>
            ...
            <div className="col-md-3 col-sm-6 p-4">
              <FiTruck className="mb-4" size={35} color="tomato" />
              <h3>FREE SHIPPING</h3>
              <p>Orders Over $99</p>
              <div>
